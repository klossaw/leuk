...
output_dir <- "/cluster/home/yjliu_jh/projects/leukemia/data" ## change output dir here
readr::write_tsv(flt3_itd_fil, glue("{output_dir}/itd_merged_filt3r.tsv")) 
...
readr::write_tsv(all_flt3, glue("{output_dir}/itd_merged_flt3_hamlet.tsv")) 
readr::write_tsv(all_kmt2a, glue("{output_dir}/itd_merged_kmt2a_hamlet.tsv")) 
